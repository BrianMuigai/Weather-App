...
data class Main(
    ...
    @SerializedName("feels_like") @Expose val feelsLike: Double,
    ...
    @SerializedName("sea_level") @Expose val seaLevel: Int,
    @SerializedName("grnd_level") @Expose val groundLevel: Int
)